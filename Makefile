...
testacc-pricemodels: deps
	TF_ACC=1 go test ./internal/provider -v -run TestAccPriceModels -timeout 30m
...
help:
	...
	@echo "  testacc-pricemodels - Run price models acceptance tests"
