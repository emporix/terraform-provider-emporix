...
testacc-pricemodule: deps
	TF_ACC=1 go test ./internal/provider -v -run TestAccPriceModule -timeout 30m
...
help:
	...
	@echo "  testacc-pricemodule - Run price module acceptance tests"
