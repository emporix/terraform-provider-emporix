...
# Example 8: Schema with ARRAY of OBJECT items
...
# Example 9: Schema for multiple entity types
...
# Example 10: Using for_each for multiple similar schemas
locals {
  entity_schemas = {
    order = {
...
# Example 11: Schema without explicit ID (auto-generated by API)
