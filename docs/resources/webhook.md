...
- [`emporix_tenant_configuration`](tenant_configuration.md) - For storing simple key-value configurations
- [`emporix_sitesettings`](sitesettings.md) - For site-level configuration
